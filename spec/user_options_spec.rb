...
describe 'User option: navigation timeout' do
  context 'when set' do
    it 'is passed as set to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com", { "navigationTimeout": 12000 })
    end
  end
  ...
  context 'when not set' do
    it 'is passed with a default value of 10000 to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com")
    end
  end
end
...
describe 'User option: user agent' do
  context 'when set' do
    it 'is passed as set to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com", { "userAgent": "Googlebot/2.1 (+http://www.google.com/bot.html)" })
    end
  end
...
describe 'User option: headless mode' do
  context 'when set' do
    it 'is passed as set to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com", { "isHeadless": false })
    end
  end
  ...
  context 'when not set' do
    it 'is passed as with a value of true to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com", { "isHeadless": true })
    end
  end
end
...
describe 'User option: view port' do
  context 'when set' do
    it 'is passed as set to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com", { "viewPort": { "width": 1920, "height": 1080 } })
    end
  end
...
describe 'User option: http authentication credentials' do
  context 'when set' do
    it 'is passed as set to the JS script' do
      ...
      Dhalang::Screenshot.get_from_url("http://www.google.com", { "httpAuthenticationCredentials": { "username": "admin", "password": "1234" } })
    end
  end
